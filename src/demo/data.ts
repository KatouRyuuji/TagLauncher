...
export const DEMO_TAGS: Tag[] = [
  { id: 1, name: "开发", color: "#365e9d" },
  { id: 2, name: "娱乐", color: "#a34469" },
  { id: 3, name: "工作", color: "#826a23" },
  { id: 4, name: "生活", color: "#247b71" },
  { id: 5, name: "系统工具", color: "#59616b" },
  { id: 7, name: "游戏", color: "#a05e31" },
  { id: 8, name: "音乐", color: "#7050a0" },
  { id: 9, name: "电影", color: "#a14e48" },
  { id: 10, name: "编辑器", color: "#7050a0" },
  { id: 11, name: "开源", color: "#3e754f" },
  { id: 13, name: "自动化", color: "#7050a0" },
  { id: 17, name: "文档", color: "#365e9d" },
  { id: 18, name: "照片", color: "#365e9d" },
  { id: 19, name: "摄影", color: "#3e754f" },
  { id: 21, name: "艺术", color: "#a14e48" },
  { id: 22, name: "名画", color: "#755940" },
  { id: 25, name: "风景", color: "#247b71" },
  { id: 26, name: "华语流行", color: "#a34469" },
  { id: 30, name: "开放世界", color: "#826a23" },
];
