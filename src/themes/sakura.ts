...
export const sakuraTheme: ThemeDefinition = {
  ...
  variables: {
    ...
    "text-muted": "rgba(95, 106, 129, 0.85)",
    "text-faint": "rgba(95, 106, 129, 0.72)",
    "text-ghost": "#dae3ee",
    "text-placeholder": "rgba(95, 106, 129, 0.78)",
    "text-invert": "#ffffff",
    "border-default": "#dae3ee",
    "border-strong": "rgba(41, 49, 61, 0.55)",
    "accent-primary": "#5064d8",
    "accent-primary-hover": "color-mix(in srgb, #5064d8 85%, #000000)",
    "accent-primary-bg": "rgba(80, 100, 216, 0.13)",
